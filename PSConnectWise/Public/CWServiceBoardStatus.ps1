...
.EXAMPLE
    $Session = Set-CWSession -Domain "cw.example.com" -CompanyName "ExampleInc" -PublicKey "VbN85MnY" -PrivateKey "ZfT05RgN";
...
function Get-CWServiceBoardStatus
{
    ...
    Begin
    {
        ...
        if ($Session -ne $null)
        {
            $BoardStatusSvc = [CwApiServiceBoardStatusSvc]::new($Session);
        } 
        else 
        {
